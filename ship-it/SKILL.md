...
Run from the product repo you want to ship. Studio root = `C:/Projects/animations`
(rendering). Its launch CLI lives at `C:/Projects/animations/launch` (distribution) —
run subcommands via `node "C:/Projects/animations/launch/dist/index.js" <cmd>` or
`npx --prefix "C:/Projects/animations/launch" launch <cmd>`, from the product repo so
