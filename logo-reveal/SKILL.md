...
also read `C:/Projects/animations/docs/playbook/blender.md` and
`C:/Projects/animations/docs/playbook/remotion.md`. Work happens in
...
2. Blender scene: `feeders/blender/scenes/logo_reveal_<brand>.py`. If missing, copy
   ...
   `C:/Projects/animations/docs/playbook/blender.md` FIRST (cleanup, emission 1.0, non-cyclic splines).
