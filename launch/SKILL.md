...
- **CLI (`launch/`, package `@marketing-studio/launch`)** — everything deterministic: state, validation, posting providers, research fetchers, payload rendering. Run it as `node "C:/Projects/animations/../dist/index.js" <cmd>` (or `launch <cmd>` if linked) -- the CLI lives in this package, `C:/Projects/animations/..`.
