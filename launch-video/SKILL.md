...
`C:/Projects/animations/docs/playbook/remotion.md`,
`C:/Projects/animations/docs/playbook/audio.md`, and
`C:/Projects/animations/docs/playbook/capture.md`. Work in `C:/Projects/animations`.
